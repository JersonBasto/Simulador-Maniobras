# -*- coding: utf-8 -*-
"""
Created on Tue Aug 16 19:22:13 2022

@author: Angel
"""

from DobleBarra import *
from tkinter import *
...
raiz=Tk()
raiz.title("Simulador Doble Barra")
...
#----------------------#####FUNCIONES#####_--------------------------------
def adyaIntSel(estado1,estado2,campo):
    if estado1 and estado2:
        secbpca["int"+str(campo)].configure(bg="green")
        secbrca["int"+str(campo)].configure(bg="green")
        intca["int"+str(campo)].configure(bg="green")
        intad["int"+str(campo)].configure(bg="green")
    else:
        secbpca["int"+str(campo)].configure(bg="black")
        secbrca["int"+str(campo)].configure(bg="black")
        intca["int"+str(campo)].configure(bg="black")
        intad["int"+str(campo)].configure(bg="black")
def accionInterruptor(campo):
    ...
    if prueba.sbp["SBP"+str(campo)]:   
        adyaIntSel(prueba.barraPrincipal,prueba.sbp["SBP"+str(campo)],campo)
    elif prueba.sbr["SBR"+str(campo)]:
        adyaIntSel(prueba.barraReserva,prueba.sbr["SBR"+str(campo)],campo)
    else:
        adyaIntSel(prueba.i["I"+str(campo)],prueba.i["I"+str(campo)],campo)
def accionSecBP(campo):
    messagebox.showinfo(message=prueba.accionSecBP(campo), title="Estado")
    estadoBarraPrincipal()
    estadoBarraTransferencia()
    if prueba.sbp["SBP"+str(campo)]:
        adybp["int"+str(campo)]
        if prueba.barraPrincipal:
            botonseccibp["int"+str(campo)].configure(image=sabic)
        else:
            botonseccibp["int"+str(campo)].configure(image=si1e0)
    else:
        if campo%2==0:
            botonseccibp["int"+str(campo)].configure(image=sabi)
        else:
            botonseccibp["int"+str(campo)].configure(image=sabp)
    if prueba.sbr["SBR"+str(campo)]==False:
        adyaIntSel(prueba.barraPrincipal,prueba.sbp["SBP"+str(campo)],campo)
    text.insert(END,"\n L"+str(campo)+"5 estado "+ str(prueba.sbp["SBP"+str(campo)]))
def accionSecBR(campo):
    messagebox.showinfo(message=prueba.accionSecBR(campo), title="Estado")
    estadoBarraPrincipal()
    estadoBarraTransferencia()
    if prueba.sbr["SBR"+str(campo)]:
        if prueba.barraReserva:
            botonseccibr["int"+str(campo)].configure(image=sabic)
        else:
            botonseccibr["int"+str(campo)].configure(image=si1e0)
    else:
        if campo%2==0:
            botonseccibr["int"+str(campo)].configure(image=sabi)
        else:
            botonseccibr["int"+str(campo)].configure(image=sabp)
    if prueba.sbp["SBP"+str(campo)]==False:
        adyaIntSel(prueba.barraReserva,prueba.sbr["SBR"+str(campo)],campo)
    text.insert(END,"\n L"+str(campo)+"5 estado "+ str(prueba.sbr["SBR"+str(campo)]))
...
def verificarSincronismo(campo):
    messagebox.showinfo(message=prueba.accionVerInt(campo), title="Estado")
    if prueba.vs["VS"+str(campo)]:
        botonInterruptor["int"+str(campo)].configure(image=ver)
        botonVeri["int"+str(campo)].configure(bg="green")
    text.insert(END,"\n L"+str(campo)+"0 veri Sincro "+ str(prueba.vs["VS"+str(campo)]))
def accionIntAcople():
...
def estadoBarraPrincipal():
    if prueba.barraPrincipal:
        ...
        for x in range(prueba.campos):
           ...
           if prueba.sbp["SBP"+str(x+1)]:
               botonseccibp["int"+str(x+1)].configure(image=sabic)
           else:
               botonseccibp["int"+str(x+1)].configure(image=sabp)
    else:
        ...
        for x in range(prueba.campos):
           ...
           if prueba.sbp["SBP"+str(x+1)]:
               botonseccibp["int"+str(x+1)].configure(image=si1e0)
           else:
               botonseccibp["int"+str(x+1)].configure(image=sabp)
def estadoBarraTransferencia():
    if prueba.barraReserva:
        ...
        for x in range(prueba.campos):
           adybr["int"+str(x+1)].configure(bg="green")
           if prueba.vs["VS"+str(x+1)]==False and prueba.i["I"+str(x+1)]==False:
               botonVeri["int"+str(x+1)].configure(bg="yellow")
           if prueba.sbr["SBR"+str(x+1)]:
               botonseccibr["int"+str(x+1)].configure(image=sabic)
               adyaIntSel(prueba.barraReserva,prueba.sbr["SBR"+str(x+1)],(x+1))
           else:
               botonseccibr["int"+str(x+1)].configure(image=sabp)
    else:
        ...
        if prueba.siAcople:
            siAcople.configure(image=si1e0)
        for x in range(prueba.campos):
           adybr["int"+str(x+1)].configure(bg="black")
           if prueba.vs["VS"+str(x+1)]==False and prueba.i["I"+str(x+1)]==False:
               botonVeri["int"+str(x+1)].configure(bg="black")
           if prueba.sbr["SBR"+str(x+1)]:
               botonseccibr["int"+str(x+1)].configure(image=si1e0)
               adyaIntSel(prueba.barraReserva,prueba.sbr["SBR"+str(x+1)],(x+1))
           else:
               botonseccibr["int"+str(x+1)].configure(image=sabp)
...
def estadoExtremoRemoto(campo):
    ...
    if prueba.et["ET"+str(campo)]:
        ...
        text.insert(END,"\n ET"+str(campo)+" estado "+ str(prueba.et["ET"+str(campo)]))
def verIAcople():
    messagebox.showinfo(message=prueba.accionVerIntAcople(), title="Estado")
    if prueba.vsAcople:
        vsAcople.configure(bg="green")
    else:
        vsAcople.configure(bg="yellow")
...
vsAcople=Button(Frame1,text="IA",bg="yellow", command=verIAcople)
vsAcople.place(x=((300*ancho)/2)-50,y=350, width=10, height=50)
...
for c in range(campos):
    ...
    if x%2==0:
       ...
       #botonsecctrans["int"+str(c+1)]=Button(Frame1,text="SS "+ str(c+1),command=lambda x=x : accionSecST(x),image=sabp)
        ...
        botonseccibp["int"+str(c+1)]=Button(Frame1,text="SI"+ str(c+1),command=lambda x=x : accionSecBP(x),image=sabp)
        botonseccibr["int"+str(c+1)]=Button(Frame1,text="SI"+ str(c+1),command=lambda x=x : accionSecBR(x),image=sabp)
        #adybt["int"+str(c+1)]=Label(Frame1, bg='black', bd=3,relief="ridge")
        adybp["int"+str(c+1)]=Label(Frame1, bg='black', bd=3,relief="ridge")
        adybr["int"+str(c+1)]=Label(Frame1, bg='black', bd=3,relief="ridge")
        secbpca["int"+str(c+1)]=Label(Frame1, bg='black', bd=3,relief="ridge")
        secbrca["int"+str(c+1)]=Label(Frame1, bg='black', bd=3,relief="ridge")
        intca["int"+str(c+1)]=Label(Frame1, bg='black', bd=3,relief="ridge")
        intad["int"+str(c+1)]=Label(Frame1, bg='black', bd=3,relief="ridge")
        ...
        label["SI"+str(c+1)]=Label(Frame1,bg="white", text="L"+str(c+1)+"4")
        label["SR"+str(c+1)]=Label(Frame1,bg="white", text="L"+str(c+1)+"6")
        #----------------Posicion Botones-------------------------------------
       #botonET["int"+str(c+1)].place(x=40+correr,y=700,width=50 ,height=50)
        adyet["int"+str(c+1)].place(x=105+correr,y=710,width=20 ,height=50)
        ...
        botonseccsup["int"+str(c+1)].place(x=90+correr, y=660,width=50,height=50)
        botonInterruptor["int"+str(c+1)].place(x=90+correr,y=610,width=50,height=50)
        botonVeri["int"+str(c+1)].place(x=140+correr,y=610,width=10,height=50)
        botonseccibp["int"+str(c+1)].place(x=40+correr,y=500,width=50,height=50)
        botonseccibr["int"+str(c+1)].place(x=150+correr,y=500,width=50,height=50)
        ...
        adybr["int"+str(c+1)].place(x=165+correr,y=480,width=20,height=20)
        secbpca["int"+str(c+1)].place(x=55+correr,y=550,width=20,height=20)
        secbrca["int"+str(c+1)].place(x=165+correr,y=550,width=20,height=20)
        intca["int"+str(c+1)].place(x=55+correr,y=570,width=130,height=20)
        intad["int"+str(c+1)].place(x=105+correr,y=590,width=20,height=20)        
        #----------------Posicion Labels-------------------------------------
        label["SS"+str(c+1)].place(x=140+correr, y=660,width=50,height=50)
        #abel["ST"+str(c+1)].place(x=190+correr,y=615,width=50 ,height=50)
        label["I"+str(c+1)].place(x=150+correr,y=610,width=40,height=25)
        label["VS"+str(c+1)].place(x=150+correr,y=635,width=40,height=25)
        label["SI"+str(c+1)].place(x=90+correr,y=500,width=50,height=50)
        label["SR"+str(c+1)].place(x=200+correr,y=500,width=50,height=50)
        ...
        adyet["int"+str(c+1)].place(x=105+correr,y=5,width=20 ,height=35)
        ...
        botonseccsup["int"+str(c+1)].place(x=90+correr, y=40,width=50,height=50)
        botonInterruptor["int"+str(c+1)].place(x=90+correr,y=90,width=50,height=50)
        botonVeri["int"+str(c+1)].place(x=140+correr,y=90,width=10,height=50)
        botonseccibp["int"+str(c+1)].place(x=40+correr,y=200,width=50,height=50)
        botonseccibr["int"+str(c+1)].place(x=150+correr,y=200,width=50,height=50)
        ...
        adybr["int"+str(c+1)].place(x=165+correr,y=250,width=20,height=210)
        secbpca["int"+str(c+1)].place(x=55+correr,y=180,width=20,height=20)
        secbrca["int"+str(c+1)].place(x=165+correr,y=180,width=20,height=20)
        intca["int"+str(c+1)].place(x=55+correr,y=160,width=130,height=20)
        intad["int"+str(c+1)].place(x=105+correr,y=140,width=20,height=20)
        
        #----------------Posicion Labels-------------------------------------
        label["SS"+str(c+1)].place(x=140+correr, y=40,width=50,height=50)
        #label["ST"+str(c+1)].place(x=190+correr,y=85,width=50 ,height=50)
        label["I"+str(c+1)].place(x=150+correr,y=90,width=40,height=25)
        label["VS"+str(c+1)].place(x=150+correr,y=115,width=40,height=25)
        label["SI"+str(c+1)].place(x=90+correr,y=200,width=50,height=50)
        label["SR"+str(c+1)].place(x=200+correr,y=200,width=50,height=50)
#---------------------------------Funciones Errores----------------------------------------
